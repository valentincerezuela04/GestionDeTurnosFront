...
export class DetailsEmpleado implements OnInit, OnDestroy {
        ...
        switchMap((params) => {
          ...
          if (!Number.isFinite(id)) {
            ...
            this.uiAlert.show({
              ...
              tone: 'soft',
              title: 'Error',
              message: 'Identificador de empleado inválido.',
              timeoutMs: 4500,
            });
  ...
  cancelarEdicion(): void {
    ...
    this.uiAlert.show({
      ...
      tone: 'soft',
      title: 'Warning alert',
      message: 'Edición cancelada. No se guardaron cambios.',
      timeoutMs: 2500,
    });
  }
      ...
      .subscribe({
        ...
        error: (error) => {
          ...
          this.uiAlert.show({
            ...
            tone: 'soft',
            title: 'Error',
            message: 'No se pudo actualizar el empleado. Intenta nuevamente.',
            timeoutMs: 5000,
          });
        },
      });
